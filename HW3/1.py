...
# Load the input image (assumed to be the clean X-ray: 1.png) in grayscale.
...
# Periodic noise appears as a pair of bright, symmetric peaks (spikes) 
# in the frequency spectrum.

# Noise Frequencies (Relative coordinates):
# These values determine the angle and density of the diagonal stripes.
...
# IMPORTANT: INCREASED NOISE AMPLITUDE for more visible stripes.
...
plt.title('Output with Periodic Noise (Synthetic 2.png)')
plt.axis('off')
...
output_filename = 'FINAL_NOISY_OUTPUT_v2.png'
